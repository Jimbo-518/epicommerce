            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                        ...
                        <form action="horarios/guardar" method="POST" class="form-horizontal">
                            <input type="hidden" name="id_depto_edificio"
                                value="<?= htmlspecialchars($id_depto_edificio) ?>">
                                ...
                                <tbody>
                                    <?php foreach ($horarios as $h): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<?= BASE_URL ?>horarios/eliminar" method="POST"
                                                    style="display:inline;">
                                                    <input type="hidden" name="id_horario" value="<?= $h['id_horario'] ?>">
                                                    <input type="hidden" name="id_depto_edificio"
                                                        value="<?= $id_depto_edificio ?>">
